...
PROMPT_TEMPLATE_PADRAO: str = (
    ...
    "    REGRA DE DESTINATÁRIOS: O destinatário sempre está mencionado na ementa da propositura. Pessoas ou instituições mencionadas apenas no corpo do texto, mas não na ementa, nunca devem ser incluídas na lista 'destinatarios'.\n"
...
PROMPT_TEMPLATE_PESAR_PADRAO: str = (
    ...
    "    REGRA DE DESTINATÁRIOS: O destinatário sempre está mencionado na ementa do requerimento. Pessoas ou instituições mencionadas apenas no corpo do texto, mas não na ementa, nunca devem ser incluídas na lista 'destinatarios'.\n"
    "    Classifique cada destinatário pelo campo 'tipo':\n"

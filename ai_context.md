...
MODELO_IA: str                  # loaded from keyring; default "gemini-3.5-flash"
...
```python
DEFAULT_MODELO_IA = "gemini-3.5-flash"
...
- Default model: `gemini-3.5-flash` (stored in `keyring`; overridable per-session via Advanced dialog).
